@extends('layouts.app')
@section('content')
<div style="background-color: rgba(255, 255, 255, 0.7); margin-top: 60px; padding-top: 50px; padding-bottom: 50px;">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <h5 class="text-center" style="color: #000">CREATE ADMIN USER</h5>
                        <br>
