        ...
        <div class="container-fluid ">
          <div class="row">
            ...
            <div class="col-10" style="background-color: rgba(50, 140, 193, 0.3);">
              ...
              <form action="/search-victims-more-info-socialwork" method="GET">
                ...
                <table class="table ">
                  <thead class="text-center">
                    <tr>
                      ...
                      <th scope="col">Witnessed by:</th>
                      <th scope="col">Interviewed/Registered by:</th>
                  ...
                  <tbody class= "text-center">
                    <tr>
                      ...
                      <td style="width: 10%">{{$class->infoSource}}</td>
                      <td style="width: 12%">{{$class->witness}}</td>
                      <td style="width: 10%">{{$class->interviewer}}</td>
                      <td style="width: 12%">{{$class->dateRegistered}}</td>
                      <td style="width: 10%">{{$class->validator}}</td>
                      <td style="width: 12%">{{$class->dateValidated}}</td>
                    </tr>
                  </tbody>
                  @endforeach
                </table>
