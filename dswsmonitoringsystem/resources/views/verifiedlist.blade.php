        ...
        <div class="row">
          ...
          <div class="col-10" style="background-color: rgba(50, 140, 193, 0.3);">
            ...
            <div class="btn-group float-right btn-top-right" role="group" aria-label="">
              <form action="/final-list" method="GET">
                <input type="hidden" name="codename" value ="{{$class->codeName}}"/>
                <button type="submit" class="btn btn-secondary btn-space" style="width: 150px; height: 40px">Partial List</button>
              </form>
              <form action="/verifiedlist" method="GET">
                <input type="hidden" name="codename" value ="{{$class->codeName}}"/>
                <button type="submit" class="btn btn-secondary btn-active" style="width: 150px; height: 40px">Final List</button>
              </form>
            </div>
            @endforeach
            <br><br><br>
            ...
            <br><br>
            <div class="btn-group float-right" role="group" aria-label="">
              <form action="/verifiedlist/verified-pdf" method="GET">
                <input type="hidden" name="codename" value ="{{$class->codeName}}"/>
                <button type="submit" class="btn btn-secondary btn-print">Print Validated List</button>
              </form>

            </div>
            <br><br><br>
            <h5 align="center" style="color: #000; padding-bottom: 10px; margin-left: 5px;"> Final list of fire victims. Data includes the validated fire victims only.</h5>
            <form action="/search-verified-list" method="GET">
